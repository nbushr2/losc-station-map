#!/usr/bin/env python3
"""
Simple Louisiana Weather Data Generator
Usage: python generate_data.py START_DATE END_DATE

Example: python generate_data.py 20260114 20260120
"""
...
# Check arguments
if len(sys.argv) != 3:
    print("Usage: python generate_data.py START_DATE END_DATE")
    print("Example: python generate_data.py 20260114 20260120")
...
try:
    ...
    print("Make sure the station list file is in the same directory")
    sys.exit(1)
...
try:
    ...
    print("  - Verify ACIS API is accessible")
    print("  - Try with a smaller date range")
    sys.exit(1)
...
out_columns = [
    ...
    "Avg T-Max", "Avg T-Min", "T-Avg", "T-Avg DFN", "Highest T-Max", "Lowest T-Min", 
    "HDD", "HDD DFN", "CDD", "CDD DFN", "Total P", "Normal P", "P-DFN", "1-Day Max", 
    "P-Max Date", "P-Days", "Missing T-Avg", "Missing Total P"
]
...
output_file = "weather_summary_with_coords.csv"
df.to_csv(output_file, index=False)

print(f"\n✅ SUCCESS!")
print(f"   File created: {output_file}")
print(f"   Stations: {len(weather_data)}")
print(f"   Date range: {start_date} to {end_date}")
print(f"\n📤 Next step: Upload this file to GitHub /data/ folder")
